<%@ Page Language="C#" MasterPageFile="~/masterpage.Master" AutoEventWireup="true"
    CodeBehind="BagsControlCountDenied.aspx.cs" Inherits="JIIS.Web.Phase3.Tracking.BagsControlCountDenied"
                ...
                <div id="reasons" runat="server">
                    ...
                    <div style="text-align: left;">
                        ...
                        <asp:GridView ID="GridView1" runat="server" Width="560px" SkinID="KVoteGridView"
                            ShowHeader="False" AutoGenerateColumns="False" DataSourceID="dsDenyReasons" PageSize="100"
                    ...
                    <table width="100%">
                        <tr>
                            <td class="left_table_cell">
                                <asp:Label ID="lblNBag" runat="server" Text="<%$Resources:LanguageText, tr_deniedBeforeVerification%>"></asp:Label>
                            </td>
                            <td class="right_table_cell">
                                <asp:TextBox ID="tBoxDeniedEnv" runat="server" ValidationGroup="Save" MaxLength="6"
                                    CssClass="text_box"></asp:TextBox>
                                <cc1:FilteredTextBoxExtender ID="tBoxDeniedEnv_FilteredTextBoxExtender" FilterType="Numbers"
                                    FilterMode="ValidChars" runat="server" Enabled="True" TargetControlID="tBoxDeniedEnv">
                                </cc1:FilteredTextBoxExtender>
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" ControlToValidate="tBoxDeniedEnv"
                                    runat="server" ValidationGroup="Save" ErrorMessage="*"></asp:RequiredFieldValidator>
                            </td>
                        </tr>
                        <tr>
