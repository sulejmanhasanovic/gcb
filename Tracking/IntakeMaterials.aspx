<%@ Page Language="C#" MasterPageFile="~/masterpage.Master" AutoEventWireup="true"
    CodeBehind="IntakeMaterials.aspx.cs" Inherits="JIIS.Web.Phase3.Tracking.IntakeMaterials"
    Theme="Default" %>
    ...
    <div id="MainBody">
            ...
            <ContentTemplate>
                ...
                <table width="100%">
                    ...
                    <div runat="server" id="skrij" visible="false">
                        <tr>
                            <td class="left_table_cell">
                                <asp:Label ID="lblLevel0" runat="server" CssClass="text12_normal" 
                                    Text="<%$Resources:LanguageText, p3_PollingStationCode%>"></asp:Label>
                            </td>
                            <td class="right_table_cell">
                                <asp:DropDownList ID="ddlPsCode" runat="server" AutoPostBack="True" 
                                    CssClass="drop_down_list" DataSourceID="SqlDataSource1" DataTextField="PSCode" 
                                    DataValueField="PSCode" OnDataBound="ddlLevels_DataBound" onselectedindexchanged="ddlPsCode_SelectedIndexChanged" 
                                  >
                                </asp:DropDownList>
                            </td>
                        </tr>
                ...
                <asp:GridView ID="gvUsers" runat="server" AutoGenerateColumns="False" SkinID="KVoteGridView"
                    PageSize="1000" DataSourceID="SqlDataSource3" Width="100%"
                    OnRowDataBound="gvUsers_RowDataBound" DataKeyNames="ID" 
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="Material" HeaderText= "<%$Resources:LanguageText, p3_materialName%>"   ItemStyle-HorizontalAlign="Left"
                ...
                <asp:SqlDataSource ID="SqlDataSource3" runat="server" 
                    ...
                    SelectCommand="p3_Get_IntakeMaterials" SelectCommandType="StoredProcedure">
                    <SelectParameters>
                        <asp:ControlParameter ControlID="ddlPsCode" Name="psCode" 
        ...
        <div style="height: 10px;">
                                <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                                    ConnectionString="<%$ ConnectionStrings:BVOTEConnectionString %>" 
                                    SelectCommand="p3_IntakeMaterials" 
                SelectCommandType="StoredProcedure">
                                    <SelectParameters>
                                        <asp:ControlParameter ControlID="ddlLevels" Name="level" 
                                            PropertyName="SelectedValue" Type="String" />
                                    </SelectParameters>
                                </asp:SqlDataSource>
        </div>
