<%@ Page Language="C#" MasterPageFile="~/masterpage.Master" AutoEventWireup="true"
    Theme="Default" CodeBehind="CCZR_OtvorenaLista1.aspx.cs" Inherits="JIIS.Web.Phase3.Tracking.Results.CCZR_OtvorenaLista1"
    Title="BiH-Vote" %>
  ...
  window.scrollTo(0,0) 
    ...
    <div id="MainBody">
        ...
        <table>
            <tr>
                <td>
                    <asp:Label ID="lblCheck1" runat="server" Visible="False" ForeColor="Red" Text="<%$ Resources:LanguageText, p3_eror1 %>"
                        Font-Bold="True" Font-Size="Larger"></asp:Label>
                </td>
            </tr>
            <tr>
                <td>
                    <asp:Label ID="lblCheck2" runat="server" Visible="False" ForeColor="Red" Text="<%$ Resources:LanguageText, p3_eror2 %>"
                        Font-Bold="True" Font-Size="Larger"></asp:Label>
                </td>
            </tr>
            <tr>
                <td>
                    <asp:Label ID="lblCheck3" runat="server" Visible="False" ForeColor="Red" Text="<%$ Resources:LanguageText, p3_eror3 %>"
                        Font-Bold="True" Font-Size="Larger"></asp:Label>
                </td>
            </tr>
            <tr>
                <td>
                    <asp:Label ID="lblCheck4" runat="server" Visible="False" ForeColor="Red" Text="<%$ Resources:LanguageText, p3_eror4 %>"
                        Font-Bold="True" Font-Size="Larger"></asp:Label>
                </td>
            </tr>
            <tr>
                <td>
                    <asp:Label ID="lblCheck5" runat="server" Visible="False" ForeColor="Red" Text="<%$ Resources:LanguageText, p3_eror5 %>"
                        Font-Bold="True" Font-Size="Larger"></asp:Label>
                </td>
            </tr>
        ...
        <asp:ValidationSummary ID="ValidationSummary1" runat="server" DisplayMode="SingleParagraph"
            HeaderText="SVA POLJA NISU UNESENA / СВИ ПОЈЛА НИСУ УНЕСЕНА" ShowMessageBox="True"
            ShowSummary="False" />
        <br />
        <table style="padding: 0px; margin: 0px; border: 2px solid #000000; width: 100%;
            border-collapse: collapse;">
            ...
            <tr>
                ...
                <td class="right_table_cell_ZR" style="width: 30%; text-align: center;">
                    <asp:TextBox ID="txt3" runat="server" CssClass="text_box_bih" Width="20%" MaxLength="4"
                        Style="text-align: right"></asp:TextBox>
            ...
            <tr>
                ...
                <td class="right_table_cell_ZR" style="width: 30%; text-align: center;">
                    <asp:TextBox ID="txtA" runat="server" CssClass="text_box_bih" Width="20%" MaxLength="4"
                        Style="text-align: right"></asp:TextBox>
            ...
            <tr>
                ...
                <td class="right_table_cell_ZR" style="width: 30%; text-align: center;">
                    <asp:TextBox ID="txtB" runat="server" CssClass="text_box_bih" Width="20%" MaxLength="4"
                        Style="text-align: right"></asp:TextBox>
            ...
            <tr>
                ...
                <td class="right_table_cell_ZR" style="width: 30%; text-align: center;">
                    <asp:TextBox ID="txtC" runat="server" CssClass="text_box_bih" Width="20%" MaxLength="4"
                        Style="text-align: right"></asp:TextBox>
            ...
            <tr>
                ...
                <td class="right_table_cell_ZR" style="width: 30%; text-align: center;">
                    <asp:TextBox ID="txtD1" runat="server" CssClass="text_box_bih" Width="20%" MaxLength="4"
                        Style="text-align: right"></asp:TextBox>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ErrorMessage="*"
                        ControlToValidate="txtD1" Display="Dynamic"></asp:RequiredFieldValidator>
            ...
            <tr>
                ...
                <td class="right_table_cell_ZR" style="width: 30%; text-align: center;">
                    <asp:TextBox ID="txtD2" runat="server" CssClass="text_box_bih" Width="20%" MaxLength="4"
                        Style="text-align: right"></asp:TextBox>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" ErrorMessage="*"
                        ControlToValidate="txtD2" Display="Dynamic"></asp:RequiredFieldValidator>
            ...
            <tr>
                ...
                <td class="right_table_cell_ZR" style="width: 30%; text-align: center;">
                    <asp:TextBox ID="txtD" runat="server" CssClass="text_box_bih" Width="20%" MaxLength="4"
                        Style="text-align: right"></asp:TextBox>
            ...
            <tr>
                ...
                <td class="right_table_cell_ZR" style="width: 30%; text-align: center;">
                    <asp:TextBox ID="txtE" runat="server" CssClass="text_box_bih" Width="20%" MaxLength="4"
                        Style="text-align: right"></asp:TextBox>
            ...
            <tr>
                ...
                <td class="right_table_cell_ZR" style="width: 30%; text-align: center;">
                    <asp:TextBox ID="txtF" runat="server" CssClass="text_box_bih" Width="20%" MaxLength="4"
                        Style="text-align: right"></asp:TextBox>
        ...
        <table style="width: 100%;">
            <tr>
                <td style="text-align: right;">
                    <asp:Button ID="Button1" runat="server" Text="<%$ Resources:LanguageText, bNext  %>"
