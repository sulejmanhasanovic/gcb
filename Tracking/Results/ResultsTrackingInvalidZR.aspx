<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ResultsTrackingInvalidZR.aspx.cs" Inherits="JIIS.Web.Phase3.Tracking.Results.ResultsTrackingInvalidZR"
...
<asp:Content ID="cAdminUsers" ContentPlaceHolderID="cphContent" runat="server">
    ...
    <div id="PageTitle">
        <%=LanguageText.zzInvalidPollingStation%><hr
                  ...
                  <table>
                    ...
                    SkinID="KVoteGridView" 
                     PageSize="50" AllowPaging="True" 
                            ...
                            <Columns>
                             <asp:BoundField DataField="PS" SortExpression="PS" 
                             HeaderText="<%$ Resources:LanguageText, p3_PollingStation %>">
                        </asp:BoundField>
                               <asp:BoundField DataField="Race" SortExpression="Race" 
                             HeaderText="<%$ Resources:LanguageText, p1candidacyrace %>">
                        </asp:BoundField>
                               <asp:BoundField DataField="codel" SortExpression="codel" 
                             HeaderText="<%$ Resources:LanguageText, p2Code %>">
                        </asp:BoundField>
                          
                               <asp:BoundField DataField="Valid" SortExpression="Valid" 
                             HeaderText="<%$ Resources:LanguageText, p2_Validated %>">
                        </asp:BoundField>
                        
                               <asp:BoundField DataField="Total" SortExpression="Total" 
                             HeaderText="<%$ Resources:LanguageText, p2_total %>">
                        </asp:BoundField>
                            </Columns>
                    <EmptyDataTemplate>
                        ...
                        <asp:SqlDataSource ID="SqlDataSource2" runat="server" 
                            ConnectionString="<%$ ConnectionStrings:BVOTEConnectionString %>" 
                            SelectCommand="p3_ResultsTrackingInvalidZR" 
