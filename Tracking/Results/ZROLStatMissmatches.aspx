<%@ Page Language="C#" MasterPageFile="~/masterpage.Master" AutoEventWireup="true"
    Theme="Default" CodeBehind="ZROLStatMissmatches.aspx.cs" Inherits="JIIS.Web.Phase3.Tracking.Results.ZROLStatMissmatches"
    Title="BiH-Vote" %>
            ...
            <ContentTemplate>
                ...
                <table style="padding: 0px; margin: 0px; border: 2px solid #000000; width: 100%;
                    ...
                    <tr>
                        ...
                        <td class="right_table_cell_ZR" style="width: 15%; text-align: center;">
                            <asp:TextBox ID="txt11" runat="server" CssClass="text_box_bih" Width="50px" ReadOnly="True"></asp:TextBox>
                        </td>
                        <td class="right_table_cell_ZR" style="width: 15%; text-align: center;">
                            <asp:TextBox ID="txt12" runat="server" CssClass="text_box_bih" Width="50px" ReadOnly="True"></asp:TextBox>
                        </td>
                        <td class="right_table_cell_ZR" style="width: 15%; text-align: center;">
                            <asp:TextBox ID="txt13" runat="server" MaxLength="4" CssClass="text_box_bih" Width="50px"></asp:TextBox>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txt13"
                    ...
                    <tr>
                        ...
                        <td class="right_table_cell_ZR" style="width: 15%; text-align: center;">
                            <asp:TextBox ID="txt21" runat="server" CssClass="text_box_bih" Width="50px" ReadOnly="True"></asp:TextBox>
                        </td>
                        <td class="right_table_cell_ZR" style="width: 15%; text-align: center;">
                            <asp:TextBox ID="txt22" runat="server" Width="50px" CssClass="text_box_bih" ReadOnly="True"></asp:TextBox>
                        </td>
                        <td class="right_table_cell_ZR" style="width: 15%; text-align: center;">
                            <asp:TextBox ID="txt23" runat="server" MaxLength="4" CssClass="text_box_bih" Width="50px"></asp:TextBox>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="txt23"
                                ErrorMessage="*"></asp:RequiredFieldValidator>
                    ...
                    <tr>
                        ...
                        <td class="right_table_cell_ZR" style="width: 15%; text-align: center;">
                            <asp:TextBox ID="txt31" runat="server" CssClass="text_box_bih" Width="50px" ReadOnly="True"></asp:TextBox>
                        </td>
                        <td class="right_table_cell_ZR" style="width: 15%; text-align: center;">
                            <asp:TextBox ID="txt32" runat="server" Width="50px" ReadOnly="True" CssClass="text_box_bih"></asp:TextBox>
                        </td>
                        <td class="right_table_cell_ZR" style="width: 15%; text-align: center;">
                            <asp:TextBox ID="txt33" runat="server" MaxLength="4" CssClass="text_box_bih" Width="50px"></asp:TextBox>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="txt33"
                                ErrorMessage="*"></asp:RequiredFieldValidator>
                    ...
                    <tr>
                        ...
                        <td class="right_table_cell_ZR" style="width: 15%; text-align: center;">
                            <asp:TextBox ID="txtA1" runat="server" CssClass="text_box_bih" Width="50px" ReadOnly="True"></asp:TextBox>
                        </td>
                        <td class="right_table_cell_ZR" style="width: 15%; text-align: center;">
                            <asp:TextBox ID="txtA2" runat="server" Width="50px" ReadOnly="True" CssClass="text_box_bih"></asp:TextBox>
                        </td>
                        <td class="right_table_cell_ZR" style="width: 15%; text-align: center;">
                            <asp:TextBox ID="txtA3" runat="server" MaxLength="4" CssClass="text_box_bih" Width="50px"></asp:TextBox>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="txtA3"
                                ErrorMessage="*"></asp:RequiredFieldValidator>
                    ...
                    <tr>
                        ...
                        <td class="right_table_cell_ZR" style="width: 15%; text-align: center;">
                            <asp:TextBox ID="txtB1" runat="server" CssClass="text_box_bih" Width="50px" ReadOnly="True"></asp:TextBox>
                        </td>
                        <td class="right_table_cell_ZR" style="width: 15%; text-align: center;">
                            <asp:TextBox ID="txtB2" runat="server" Width="50px" ReadOnly="True" CssClass="text_box_bih"></asp:TextBox>
                        </td>
                        <td class="right_table_cell_ZR" style="width: 15%; text-align: center;">
                            <asp:TextBox ID="txtB3" runat="server" MaxLength="4" CssClass="text_box_bih" Width="50px"></asp:TextBox>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ControlToValidate="txtB3"
                                ErrorMessage="*"></asp:RequiredFieldValidator>
                    ...
                    <tr>
                        ...
                        <td class="right_table_cell_ZR" style="width: 15%; text-align: center;">
                            <asp:TextBox ID="txtC1" runat="server" CssClass="text_box_bih" Width="50px" ReadOnly="True"></asp:TextBox>
                        </td>
                        <td class="right_table_cell_ZR" style="width: 15%; text-align: center;">
                            <asp:TextBox ID="txtC2" runat="server" Width="50px" ReadOnly="True" CssClass="text_box_bih"></asp:TextBox>
                        </td>
                        <td class="right_table_cell_ZR" style="width: 15%; text-align: center;">
                            <asp:TextBox ID="txtC3" runat="server" MaxLength="4" CssClass="text_box_bih" Width="50px"></asp:TextBox>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ControlToValidate="txtC3"
                                ErrorMessage="*"></asp:RequiredFieldValidator>
                    ...
                    <tr>
                        ...
                        <td class="right_table_cell_ZR" style="width: 15%; text-align: center;">
                            <asp:TextBox ID="txtD11" runat="server" CssClass="text_box_bih" Width="50px" ReadOnly="True"></asp:TextBox>
                        </td>
                        <td class="right_table_cell_ZR" style="width: 15%; text-align: center;">
                            <asp:TextBox ID="txtD12" runat="server" Width="50px" ReadOnly="True" CssClass="text_box_bih"></asp:TextBox>
                        </td>
                        <td class="right_table_cell_ZR" style="width: 15%; text-align: center;">
                            <asp:TextBox ID="txtD13" runat="server" MaxLength="4" CssClass="text_box_bih" Width="50px"></asp:TextBox>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" ControlToValidate="txtD13"
                                ErrorMessage="*"></asp:RequiredFieldValidator>
                    ...
                    <tr>
                        ...
                        <td class="right_table_cell_ZR" style="width: 15%; text-align: center;">
                            <asp:TextBox ID="txtD21" runat="server" CssClass="text_box_bih" Width="50px" ReadOnly="True"></asp:TextBox>
                        </td>
                        <td class="right_table_cell_ZR" style="width: 15%; text-align: center;">
                            <asp:TextBox ID="txtD22" runat="server" Width="50px" ReadOnly="True" CssClass="text_box_bih"></asp:TextBox>
                        </td>
                        <td class="right_table_cell_ZR" style="width: 15%; text-align: center;">
                            <asp:TextBox ID="txtD23" runat="server" MaxLength="4" CssClass="text_box_bih" Width="50px"></asp:TextBox>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server" ControlToValidate="txtD23"
                                ErrorMessage="*"></asp:RequiredFieldValidator>
                    ...
                    <tr>
                        ...
                        <td class="right_table_cell_ZR" style="width: 15%; text-align: center;">
                            <asp:TextBox ID="txtD1" runat="server" CssClass="text_box_bih" Width="50px" ReadOnly="True"></asp:TextBox>
                        </td>
                        <td class="right_table_cell_ZR" style="width: 15%; text-align: center;">
                            <asp:TextBox ID="txtD2" runat="server" Width="50px" ReadOnly="True" CssClass="text_box_bih"></asp:TextBox>
                        </td>
                        <td class="right_table_cell_ZR" style="width: 15%; text-align: center;">
                            <asp:TextBox ID="txtD3" runat="server" MaxLength="4" CssClass="text_box_bih" Width="50px"></asp:TextBox>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator10" runat="server" ControlToValidate="txtD3"
                                ErrorMessage="*"></asp:RequiredFieldValidator>
                    ...
                    <tr>
                        ...
                        <td class="right_table_cell_ZR" style="width: 15%; text-align: center;">
                            <asp:TextBox ID="txtE1" runat="server" CssClass="text_box_bih" Width="50px" ReadOnly="True"></asp:TextBox>
                        </td>
                        <td class="right_table_cell_ZR" style="width: 15%; text-align: center;">
                            <asp:TextBox ID="txtE2" runat="server" Width="50px" ReadOnly="True" CssClass="text_box_bih"></asp:TextBox>
                        </td>
                        <td class="right_table_cell_ZR" style="width: 15%; text-align: center;">
                            <asp:TextBox ID="txtE3" runat="server" MaxLength="4" CssClass="text_box_bih" Width="50px"></asp:TextBox>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator11" runat="server" ControlToValidate="txtE3"
                                ErrorMessage="*"></asp:RequiredFieldValidator>
                    ...
                    <tr>
                        ...
                        <td class="left_table_cell_ZR" style="text-align: left">
                            <asp:Label ID="Label27" runat="server" Text="<%$ Resources:LanguageText, rt_ZRStatBoxF %>"
                                CssClass="text11_normal"></asp:Label>
                        </td>
                        <td class="right_table_cell_ZR" style="width: 15%; text-align: center;">
                            <asp:TextBox ID="txtF1" runat="server" CssClass="text_box_bih" Width="50px" ReadOnly="True"></asp:TextBox>
                        </td>
                        <td class="right_table_cell_ZR" style="width: 15%; text-align: center;">
                            <asp:TextBox ID="txtF2" runat="server" Width="50px" ReadOnly="True" CssClass="text_box_bih"></asp:TextBox>
                        </td>
                        <td class="right_table_cell_ZR" style="width: 15%; text-align: center;">
                            <asp:TextBox ID="txtF3" runat="server" MaxLength="4" CssClass="text_box_bih" Width="50px"></asp:TextBox>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator12" runat="server" ControlToValidate="txtF3"
                                ErrorMessage="*"></asp:RequiredFieldValidator>
