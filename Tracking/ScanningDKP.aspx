<%@ Page Language="C#" MasterPageFile="~/masterpage.Master" AutoEventWireup="true"
    CodeBehind="ScanningDKP.aspx.cs" Inherits="JIIS.Web.Phase3.Tracking.ScanningDKP" Theme="Default" %>
                                        ...
                                        <td style="border: thin solid #FF0000;">
                                            <table width="95%">
                                                <tr>
                                                    ...
                                                    <td colspan="3">
                                                        <asp:Label ID="lblMsg" runat="server" CssClass="text18_normal" Text="<%$ Resources:LanguageText, p3_VoterNotRegisteredDKP %>"></asp:Label>
                                                    </td>
                                                </tr>
                                                <tr>
                ...
                <table width="100%" cellpadding="0" cellspacing="0">
                    ...
                    <tr style="height: 30px; vertical-align: middle">
                        ...
                        <td align="left">
                            ...
                            <asp:CheckBox runat="server" Visible="false" ID="chbSuspicious" Checked="false"/>
                           <%-- <asp:Label runat="server">Sumnjivi potpis?</asp:Label>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
                            <asp:FileUpload runat="server" ID="upload"/>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp--%>
                    ...
                    <tr>
                        <td style="height: 10px">
                            <asp:CheckBox ID="CheckBoxPaging" runat="server" ForeColor="Black" 
                                oncheckedchanged="CheckBoxPaging_CheckedChanged" Text="Paging" AutoPostBack = "true"/>
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
