<%@ Page Language="C#" MasterPageFile="~/masterpage.Master" AutoEventWireup="true"
    CodeBehind="ScanningMobilni.aspx.cs" Inherits="JIIS.Web.Phase3.Tracking.ScanningMobilni" Theme="Default" %>
                                        ...
                                        <td style="border: thin solid #FF0000;">
                                            <table width="95%">
                                                <tr>
                                                    ...
                                                    <td colspan="3">
                                                        <asp:Label ID="lblMsg" runat="server" CssClass="text18_normal" Text="<%$ Resources:LanguageText, p3_VoterNotRegisteredMobile %>"></asp:Label>
                                                    </td>
                                                </tr>
                                                <tr>
