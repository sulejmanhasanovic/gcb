<%@ Page Language="C#" MasterPageFile="~/masterpage.Master" AutoEventWireup="true"
    CodeBehind="ScanningUnconfirmed.aspx.cs" Inherits="JIIS.Web.Phase3.Tracking.ScanningUnconfirmed"
    Theme="Default" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphContent" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function countDisplay() {
            ...
            var txtIme = document.getElementById('<%=txtName.ClientID%>');
            var numIme = txtIme.value;
            
            var txtPrezime = document.getElementById('<%=txtSurname.ClientID%>');
            var numPrezime = txtPrezime.value;
            
            var txtDatum = document.getElementById('<%=txtBirthDate.ClientID%>');
            var numDatum = txtDatum.value;
  
            if(numTxt.length == 13)
            {
                if(numIme.length > 0 && numPrezime.length > 0 && numDatum.length > 0)
                {        
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
            ...
            <ContentTemplate>
                                        ...
                                        <td style="border: thin solid #FF0000;">
                                            <table width="95%">
                                                <tr>
                                                    ...
                                                    <td colspan="3">
                                                        <asp:Label ID="lblMsg" runat="server" CssClass="text18_normal" Text="<%$ Resources:LanguageText, p3_VoterNotRegisteredUnconfirmed %>"></asp:Label>
                                                    </td>
                                                </tr>
                                                <tr>
                ...
                <table width="70%" align="left">
                    <tr>
                        <td align="right">
                            <asp:Label ID="Label4" runat="server" Text="Prihvaceni:"></asp:Label>
                        </td>
                        <td align="left">
                            <asp:Label ID="lblAccepted" runat="server"></asp:Label>
                        </td>
                        <td align="right">
                            <asp:Label ID="Label5" runat="server" Text="Odbijeni:"></asp:Label>
                        </td>
                        <td align="left">
                ...
                <table width="100%" cellpadding="0" cellspacing="0">
                    ...
                    <tr style="height: 30px; vertical-align: middle">
                        <td align="right" style="width: 45%">
                            <asp:Label ID="lblTxtScanJMB" runat="server" Text="<%$ Resources:LanguageText, jmb %>"></asp:Label>
                        </td>
                        <td align="left">
                    ...
                    <tr style="height: 30px; vertical-align: middle">
                        ...
                        <td align="left">
                           ...
                           <%-- <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="*"
                            ...
                            <%--<cc1:MaskedEditExtender ID="MaskedEditExtender1" runat="server" UserDateFormat="DayMonthYear"
                                MaskType="Date" TargetControlID="txtBirthDate" Mask="99.99.9999" InputDirection="LeftToRight"
                                AutoCompleteValue="00.00.0000">
                            </cc1:MaskedEditExtender>
                            <cc1:MaskedEditValidator ID="MaskedEditValidator1" runat="server" ControlExtender="MaskedEditExtender1"
                                ControlToValidate="txtBirthDate" Display="Dynamic" ErrorMessage="Nevalidni datum"
                                EmptyValueMessage="*" IsValidEmpty="false" ></cc1:MaskedEditValidator>--%>
                        </td>
                    </tr>
                    <tr style="height: 30px; vertical-align: middle">
                        <td align="right" style="width: 45%">
                         <%--   <asp:Label ID="LAbelChb" runat="server">Sumnjivi potpis?</asp:Label>--%>
                        </td>
                        <td align="left">
