<%@ Page Language="C#" MasterPageFile="~/masterpage.Master" AutoEventWireup="true"
    CodeBehind="StatisticsForPollingStationandMaterials2.aspx.cs" Inherits="JIIS.Web.Phase3.Tracking.StatisticsForPollingStationandMaterials2"
                    ...
                    <tr>
                        <td>
                            ...
                            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:BVOTEConnectionString %>"
                                SelectCommand="p3getStatisticForPSAndMaterialsWaitAccepted" 
                                SelectCommandType="StoredProcedure">
                                <SelectParameters>
                                    <asp:QueryStringParameter Name="code" QueryStringField="path1" Type="String" />
                                </SelectParameters>
                            </asp:SqlDataSource>
                        </td>
                    </tr>
